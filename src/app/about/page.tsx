      ...
      <main className="relative z-10 w-full mx-auto px-4 sm:px-8 py-16 lg:py-24 flex-1">
        <div className="max-w-7xl mx-auto space-y-16 lg:space-y-24">
          ...
          <SlideUp className="text-center space-y-6 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm cursor-default">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <SlideUp delay={0.2} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm rounded-3xl p-8 lg:p-12 space-y-8 flex flex-col justify-center relative overflow-hidden group">
              ...
              <div className="p-4 rounded-2xl bg-indigo-50 w-fit text-indigo-600 dark:text-indigo-300 border border-indigo-100">
                <ShieldCheck className="w-8 h-8" />
              </div>
              <div className="space-y-4 relative z-10">
                <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">Zero Backend Processing.</h2>
                <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                  We believe your proprietary code, production payloads, and sensitive tokens should never leave your machine. That's why every tool on CodeLens runs <strong className="text-slate-900 dark:text-slate-100">100% locally in your browser memory</strong> using WebAssembly.
                </p>
              </div>
            </SlideUp>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-8">
              ...
              <SlideUp delay={0.3} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm rounded-3xl p-8 space-y-6 relative group h-full overflow-hidden">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Lightning Fast</h3>
              ...
              <SlideUp delay={0.4} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm rounded-3xl p-8 space-y-6 relative group h-full overflow-hidden">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Premium UX First</h3>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
