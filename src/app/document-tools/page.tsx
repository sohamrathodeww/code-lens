    ...
    <div className="relative min-h-screen flex flex-col justify-between overflow-x-hidden font-sans bg-[#fbfcfd] text-slate-900 selection:bg-indigo-500/30">
      ...
      <main className="relative z-10 w-full mx-auto px-4 sm:px-8 flex-1 py-12 lg:py-16">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <FadeIn delay={0.3}>
            <section className="liquid-glass-surface p-8 rounded-3xl space-y-6 text-slate-700 text-sm leading-relaxed border border-white/80 mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                <div className="p-5 rounded-2xl bg-white/80 border border-slate-200/80 space-y-2 relative overflow-hidden">
                  <div className="absolute -right-4 -top-4 w-16 h-16 bg-rose-500/10 rounded-full blur-xl pointer-events-none" />
                  <h3 className="font-bold text-slate-950 text-base">1. Merge PDFs</h3>
                ...
                <div className="p-5 rounded-2xl bg-white/80 border border-slate-200/80 space-y-2 relative overflow-hidden">
                   <div className="absolute -right-4 -top-4 w-16 h-16 bg-rose-500/10 rounded-full blur-xl pointer-events-none" />
                  <h3 className="font-bold text-slate-950 text-base">2. Extract PDF Page</h3>
                  <p className="text-xs text-slate-600">
                ...
                <div className="p-5 rounded-2xl bg-white/80 border border-slate-200/80 space-y-2 relative overflow-hidden">
                  ...
                  <h3 className="font-bold text-slate-950 text-base">3. Excel to CSV</h3>
                  <p className="text-xs text-slate-600">
                ...
                <div className="p-5 rounded-2xl bg-white/80 border border-slate-200/80 space-y-2 relative overflow-hidden">
                   <div className="absolute -right-4 -top-4 w-16 h-16 bg-emerald-500/10 rounded-full blur-xl pointer-events-none" />
                  <h3 className="font-bold text-slate-950 text-base">4. Merge Excel Sheets</h3>
                  <p className="text-xs text-slate-600">
