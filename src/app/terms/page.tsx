        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="bg-white p-8 sm:p-16 border border-slate-200 rounded-[2.5rem] shadow-sm relative overflow-hidden">
            <article className="prose prose-slate prose-lg md:prose-xl max-w-4xl mx-auto">
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">1. Acceptance of Services</h3>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 my-6">
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">2. Intellectual Property Rights</h3>
              <p>
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">3. Disclaimer of Warranties & Output Accuracy</h3>
              <p>
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">4. Limitation of Liability</h3>
              <p>
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">5. Revisions to the Terms</h3>
              <p>
              ...
              <h3 className="text-3xl font-extrabold text-slate-900 mt-12 mb-6">6. Contact Information</h3>
              <p>
                If you have inquiries regarding these Terms of Service or our usage policies, please reach out to us via our <a href="/contact" className="text-indigo-600 font-bold hover:underline">Contact Us</a> page.
              </p>
            </article>
          </section>
        </div>
