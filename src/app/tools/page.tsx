        ...
        <div className="max-w-7xl mx-auto">
          ...
          <SlideUp>
            <div className="flex flex-col items-center text-center space-y-6 mb-20">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/60 shadow-sm cursor-default">
            ...
            {activeTools.map((tool, idx) => {
              ...
              return (
                <SlideUp key={tool.id} delay={delay} className="h-full">
                  <div className="group relative p-6 flex flex-col justify-between h-full rounded-3xl bg-white border border-slate-200/60 transition-all duration-400 overflow-hidden hover:border-indigo-300 hover:shadow-[0_20px_60px_-15px_rgba(79,70,229,0.15)] hover:-translate-y-1.5">
                    ...
                    <div className="space-y-6 relative z-10">
                      <div className="flex items-start justify-between">
                        <div className="p-3.5 rounded-2xl border transition-all duration-300 bg-indigo-50/50 border-indigo-100 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110 shadow-sm">
                          <Icon className="w-6 h-6" />
                        </div>

                        <span className="px-3 py-1.5 text-[10px] uppercase tracking-widest font-bold rounded-full border bg-slate-50 text-slate-600 border-slate-200 group-hover:bg-indigo-50 group-hover:text-indigo-700 group-hover:border-indigo-200 transition-colors duration-300">
                          {tool.category}
                        </span>
                      </div>
