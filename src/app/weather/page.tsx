          ...
          <FadeIn delay={0.3}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
              <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 dark:border-slate-700/80 space-y-2">
                <h3 className="font-bold text-slate-950 dark:text-white text-base">📍 Auto-Detect Location</h3>
              ...
              <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 dark:border-slate-700/80 space-y-2">
                <h3 className="font-bold text-slate-950 dark:text-white text-base">🔍 Universal Geocoding</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400">
              ...
              <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 dark:border-slate-700/80 space-y-2">
                <h3 className="font-bold text-slate-950 dark:text-white text-base">📅 Multi-Day Forecasting</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400">
